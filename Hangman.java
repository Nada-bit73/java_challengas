...
public class Hangman {
    ...
    //create gallows array to represent the trying times
    ...
    public static void main(String[] args) {
        ...
        //print the - , equal to the num of letters in the word 
        ...
        //while users still have chances
        while (misses < 6) {
...
//choose random int then use it as index
    public static String randomWord() {
        int numWords = words.length; // number of words in the array
